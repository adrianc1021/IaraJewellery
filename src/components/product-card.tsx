...
type ProductCardProps = { locale?: Locale; product: { id: string; slug: string; nameZh: string; nameEn?: string; collection: string; badge: string | null; imagesJson: string; variants: { id: string; priceMinor: number; optionName: string; active: boolean }[] } };

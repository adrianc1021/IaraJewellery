...
2. Supply `BETTER_AUTH_URL`, `NEXT_PUBLIC_APP_URL`, a unique `SEED_ADMIN_EMAIL` and a 12+ character `SEED_ADMIN_PASSWORD`, plus Stripe test keys and webhook secret.
